...
class ReportGenerator:
    ...
    REPORT_COLUMNS = [
        ...
        ("原始期刊标题 Raw Journal", "raw_journal_title"),
        ("原始ISSN Raw ISSN", "raw_issn"),
        ("原始eISSN Raw eISSN", "raw_eissn"),
        ("匹配期刊 Matched Journal", "matched_journal_title"),
        ("匹配ISSN Matched ISSN", "matched_issn"),
        ("匹配方式 Match Method", "match_method"),
        ("期刊主页 Journal Profile URL", "journal_profile_url"),
    ...
    def generate_excel_report(
        ...
        column_widths = {
            ...
            "url": 45,
            "journal": 28,
            "raw_journal_title": 28,
            "raw_issn": 14,
            "raw_eissn": 14,
            "matched_journal_title": 28,
            "matched_issn": 14,
            "match_method": 16,
            "journal_profile_url": 45,
            "impact_factor": 16,
            "impact_factor_year": 12,
            "impact_factor_source": 18,
            "impact_factor_status": 18,
            "authors": 25,
